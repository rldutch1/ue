function strInput() {
  ...
  var str1 = UltraEdit.getString("Please Enter another String:",1);
  ...
  if (str == "UltraEdit") {
    ...
    UltraEdit.activeDocument.write(str1 + " also has integrated scripting\r\n");
    UltraEdit.activeDocument.write(str1 + " includes all the functionality of UltraEdit and more.\r\n");
    UltraEdit.activeDocument.write("\r\n");
  }  else {
